      ...
      <div className="card">
        ...
        <div className="grid cols-4">
          ...
          <select className="input" value={unit} onChange={e=>setUnit(e.target.value)}>
            <option value="unidad">unidad</option><option value="g">g</option><option value="ml">ml</option>
            <option value="paquete">paquete</option><option value="tarro">tarro</option>
          </select>
